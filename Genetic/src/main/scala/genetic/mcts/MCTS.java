/*
package genetic.mcts;

import genetic.func.GeneticFuncMain$;
import genetic.params.Params;
import genetic.queens.GeneticQueenMain$;
import genetic.string.GeneticStringMain$;

import java.genetic.util.Arrays;
import java.genetic.util.LinkedList;
import java.genetic.util.List;
import java.genetic.util.Random;
...
public class MCTS {
    ...
    public static MCTS initMCTS(int size) {
        ...
        MCTS genetic.mcts = new MCTS(values);
        bestNode = genetic.mcts;
        return genetic.mcts;
    }
    ...
    public double rollOut(MCTS leaf) {
        ...
        GeneticStringMain$.MODULE$.alg(new Params(ints, leaf.values)).run(0, 0.3);
    ...
    public static void genetic.main(String[] args) {
        MCTS genetic.mcts = initMCTS(4);
        ...
        while (true) {
            ...
            if(i%100 == 0){
                MCTS best = genetic.mcts.getBest();
